...
import styles from './StandardDiet.module.scss';
    ...
    <div className={styles.standardDietContainer}>
      <div className={styles.standardDietContainer__description}>
        ...
        <div className={styles.standardDietContainer__photosWrapper}>
          <img className={styles.standardDietContainer__photosWrapper__photoBgc} src={backgroundStandard} alt="" />
          <img className={styles.standardDietContainer__photosWrapper__photoDiet} src={standard} alt="" />
        </div>
...
StandardDiet.propTypes = {};

export default StandardDiet;
