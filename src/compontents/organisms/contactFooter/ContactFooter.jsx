  ...
  return (
    <div className={styles.contactFooterContainer}>
      <ul className={styles.contactFooterContainer__list}>
        <li className={styles.contactFooterContainer__list__item}><span className={styles.bold}>Adres</span></li>
      ...
      <ul className={styles.contactFooterContainer__list}>
        <li className={styles.contactFooterContainer__list__item}><span className={styles.bold}>Dane firmy</span></li>
      ...
      <ul className={styles.contactFooterContainer__list}>
        <li className={styles.contactFooterContainer__list__item}><span className={styles.bold}>Nr konta</span></li>
        <li className={styles.contactFooterContainer__list__item}>69 1020 4724 0000 3602 0141 3095</li>
